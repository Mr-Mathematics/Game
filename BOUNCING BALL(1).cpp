...
int g=160;
outtextxy(100,g+=80,"WELCOME TO BOUNCING BALL GAME");
outtextxy(320,g+=80,"BY IMAD UDDIN");
outtextxy(220,g+=80,"---------------------");
outtextxy(260,g+=80,"PRESS 1 TO START");
...
void hit()
{
	/*program for changing ball direction*/
	if(n==1&&f<800)
	{ f=f+5;  }
